    ...
    <Draggable draggableId={event.id} index={index}>
      {(provided, snapshot) => (
        <motion.div
          ...
          className={cn(
            "p-2 rounded mb-1.5 cursor-pointer hover:brightness-90 transition-colors overflow-y-auto max-h-[60px] scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent",
