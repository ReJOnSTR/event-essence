          ...
          return (
            <div
              ...
              className={cn(
                ...
                holiday && !allowWorkOnHolidays && "bg-red-50 text-red-600",
                holiday && allowWorkOnHolidays && "bg-yellow-50 text-yellow-600"
              )}
            >
              ...
              {holiday && (
                <div className={cn(
                  "text-xs",
                  !allowWorkOnHolidays ? "text-red-500" : "text-yellow-600"
                )}>
                  {holiday.name}
                </div>
              )}
