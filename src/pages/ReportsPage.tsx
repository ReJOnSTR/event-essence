...
export default function Reports() {
  ...
  const shouldShowData = selectedStudent && selectedDate;
  const hours = shouldShowData ? calculatePeriodHours(lessons, selectedDate!, selectedStudent, startDate, endDate) : { weekly: 0, monthly: 0, yearly: 0 };
  const earnings = shouldShowData ? calculatePeriodEarnings(lessons, selectedDate!, selectedStudent, students, startDate, endDate) : { weekly: 0, monthly: 0, yearly: 0 };
